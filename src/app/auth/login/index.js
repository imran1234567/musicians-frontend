                        ...
                        <div className="modal-content">
                            <div className="modal-body">
                                <div className="login-modal">
                                    <div className="row">
                                        <div className="col-lg-6 pad-right-0" style={{backgroundColor:'#000', padding:'0px', margin:'0px'}}>
                                            <div className="login-modal-left center">
                                                <img src={logo} />
                                            </div>
                                        </div>
                                        <div className="col-lg-6 pad-left-0" style={{marginTop:'15px', marginBottom:'15px'}}>
                                                ...
                                                <div className="login-modal-right">
                                                    ...
                                                    <div className="tab-content">
                                                        <div className="tab-pane active" id="login" role="tabpanel">
                                                            ...
                                                            <fieldset className="form-group">
                                                                <button type="submit" className="btn btn-lg btn-secondary btn-block create-btn" onClick={this.handleSubmit}>Enter to your account</button>
                                                            </fieldset>

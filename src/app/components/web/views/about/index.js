            ...
            <div class="container-fluid">
              <div class="about-article-content">
                ...
                <p>
                  ...
                  family owned store and continues to provide good old fashioned
                  customer service.
                </p>
                <h6>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12 av-box">
                      <div class="px-lg-4 py-lg-5 py-4">
                        ...
                        <p>
                          Donec augue arcu, efficitur nec tellus vitae,
                          fermentum semper quam. Proin vel est a sapien
                          ullamcorper vestibulum. Donec in dui ac dui commodo
                          cursus vulputate id augue. Integer tempor vitae lectus
                          nec pellentesque. Quisque vitae commodo erat. Maecenas
                          suscipit, justo viverra facilisis fermentum, eros
                          dolor dignissim lacus, ut dignissim.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      >
                        <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12 av-box">
                          ...
                          <p>
                            ...
                            fermentum semper quam. Proin vel est a sapien
                            ullamcorper vestibulum. Donec in dui ac dui commodo
                            cursus vulputate id augue. Integer tempor vitae
                            lectus nec pellentesque. Quisque vitae commodo erat.
                            Maecenas suscipit, justo viverra facilisis
                            fermentum, eros dolor dignissim lacus, ut dignissim.
                          </p>
                        </div>
                        <div class="px-lg-4 py-lg-5 py-4">
                          {" "}

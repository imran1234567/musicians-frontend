                ...
                <div className="cart-sidebar">
                        ...
                        {cartItems.map((row, index) => (
                            <div className="cart-item" key={index}>
                                <div className="cart-product-img">
                                    ...
                                    <img className="img-fluid" src="https://cdn.pixabay.com/photo/2013/07/13/10/06/violin-156558_1280.png" alt="cart" />
                                   
                                    <div className="offer-badge">{row.discountPer}% OFF</div>
                                </div>
                                <div className="cart-text">
                                    <h4 style={{color:'#545454', fontSize:'15px'}}>{row.name}</h4>
                    ...
                    <div className="cart-sidebar-footer">
                        <div className="cart-store-details">
                            ...
                            Delivery Charges <strong className="float-right text-danger">+ &#x24;29.69</strong></p>
                            <h6 style={{ display: 'flex', justifyContent: 'space-between' }}>
                                Your total savings <strong className="float-right text-danger">&#x24;55 (42.31%)</strong></h6>
                        </div>

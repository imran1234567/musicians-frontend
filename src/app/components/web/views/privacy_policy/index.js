        ...
        <section className="info-term">
          ...
          <div className="info-here">
            ...
            <h6 style={{ color: "black" }}>
              ...
              Company Name customer support features you are required to submit
              personally identifiable information. This may include but not
            ...
            <h6 style={{ color: "black" }}>
              ...
              information they need to deliver the service. Company Name takes
            ...
            <br></br>
            <h6 style={{ color: "black" }}>
              Company Name reserves the right to make amendments to this Privacy
            ...
            <h6 style={{ color: "black" }}>
              ...
              security reasons. Company Name reserves the right to charge a fee
              for searching for, and providing access to, your information on a
              per request basis.
            </h6>
          </div>
        </section>

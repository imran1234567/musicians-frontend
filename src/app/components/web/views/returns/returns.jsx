...
class Returns extends React.Component {
 state = {
  ...
  render() {
    const { formErrors, captchaCode, verificationCode, submittedData } = this.state;
    const isFormValid =
      Object.values(formErrors).every((error) => !error) &&
      verificationCode === captchaCode;
    const showTryAgainMessage = verificationCode && verificationCode !== captchaCode;
              ...
              <tr>
                <td>
                  <div className="form-group">
                    ...
                    />
                    {formErrors.orderId && (
                      <span className="error-message">{formErrors.orderId}</span>
                    )}
                  </div>
                </td>
                <td>
                  <div className="form-group">
                    ...
                    {formErrors.orderDate && (
                      <span className="error-message">{formErrors.orderDate}</span>
                    )}
                  </div>
                </td>
              </tr>
            ...
            <tbody>
                ...
                <td>
                  <div className="form-group">
                    ...
                    {formErrors.productCode && (
                      <span className="error-message">{formErrors.productCode}</span>
                    )}
                  </div>
                </td>
                <td>
              ...
              <tr>
                <td>
                  <div className="form-group">
                    ...
                    >
                      ...
                      <option value="Please supply details">Please supply details</option>
                      <option value="Order Error">Order Error</option>
                      <option value="Received Wrong Item">Received Wrong Item</option>
                      <option value="Other">Other</option>
                    </select>
                    {formErrors.reasonForReturn && (
                      <span className="error-message">{formErrors.reasonForReturn}</span>
                    )}
                  </div>
                </td>
                <td>
                ...
                {formErrors.productOpened && (
                    <span className="error-message">{formErrors.productOpened}</span>
                )}
                </div>
                </td>
                <td>
                  <div className="form-group">
                    ...
                    <textarea
                        ...
                        onChange={this.handleInputChange}
                        className={`textarea-input ${formErrors.faultyDetails ? "error" : ""}`}
                        />
                    {formErrors.faultyDetails && (
                      <span className="error-message">{formErrors.faultyDetails}</span>
                    )}
                  </div>
                </td>
              </tr>
